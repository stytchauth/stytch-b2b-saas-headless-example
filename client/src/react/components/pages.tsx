		...
		<>
			...
			<div className={styles.loginForm}>
	 			...
	 			>
					...
					{message ? <div>{message}<br /></div> : null}


					<Button type="google" href={`${googleOauth}`}>
					Continue with Google
					</Button>
					<br />
					<Button type="microsoft" href={`${microsoftOauth}`}>
					Continue with Microsoft
					</Button>
					<div className={styles.divider}>or</div>
					<input className={styles.emailInput} type="email" name="email_address" placeholder="email@example.com" id="email" required />
					<Button type="email">
					Continue with Email
					</Button>
				</form>
